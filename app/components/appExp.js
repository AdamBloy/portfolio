...
export default function AppExp() {
  ...
  return (
    <main className={styles.main}>
      <div className={styles.arrowDividerAppExp}>
        <Image
      ...
      <div className={styles.appExpContainer}>
        ...
        <div className={styles.cardContainer}>
          ...
          <div className={buttonState === "1" ? visStyles : hidStyles}>
            ...
            <div className={styles.cardDetails}>
              ...
              <div className={styles.cardBody}>
                Doc Expert is a website that contains useful applications for
                use in a professional environment. I built the website from
                scratch with authentication, user account systems and databases
                using Javascript, React and Next JS, utilising MongoDB and
                next-auth.
              </div>
              <div className={styles.cardBody}>
                The website allows users to create accounts in order to use the
                tools on the site. Users can manage their accounts and access
          ...
          <div className={buttonState === "2" ? visStyles : hidStyles}>
            ...
            <div className={styles.cardDetails}>
              ...
              <div className={styles.cardBody}>
                CV Builder is a tool within the Doc Expert website which
                automates all formatting and saving of a CV document. A
                registered user simply fills out a form and upon completion the
                tool formats all information and allows the user to save a word
                document.
              </div>
              <div className={styles.cardBody}>
          ...
          <div className={buttonState === "3" ? visStyles : hidStyles}>
            ...
            <div className={styles.cardDetails}>
              ...
              <div className={styles.cardBody}>
                The legal knowledge tracker is an application which provides a
                UI for an employee to register their areas of expertise and
                relevant skills.
              </div>
              <div className={styles.cardBody}>
                The data is contained in the application for review by
                management. Additionally users can add new areas of expertise
                for others to select to allow the application to stay up to date
          ...
          <div className={buttonState === "4" ? visStyles : hidStyles}>
            ...
            <div className={styles.cardDetails}>
              ...
              <div className={styles.cardBody}>
                ...
                under the wrong date and kept the system accurate for the
                project managers.
              </div>
            </div>
          </div>
